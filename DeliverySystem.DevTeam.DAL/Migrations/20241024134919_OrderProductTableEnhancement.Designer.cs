...
namespace DeliverySystem.DevTeam.DAL.Migrations
{
    ...
    [Migration("20241024134919_OrderProductTableEnhancement")]
    partial class OrderProductTableEnhancement
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DeliverySystem.DevTeam.DAL.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("DeliverySystem.DevTeam.DAL.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("DeliverySystem.DevTeam.DAL.Models.Order", b =>
                {
                    ...
                    b.HasOne("DeliverySystem.DevTeam.DAL.Models.Delivery", "Delivery")
                        .WithMany("Orders")
                    ...
                    b.HasOne("DeliverySystem.DevTeam.DAL.Models.Warhouse", "Warehouse")
                        .WithMany()
            ...
            modelBuilder.Entity("DeliverySystem.DevTeam.DAL.Models.OrderProduct", b =>
                {
                    ...
                    b.HasOne("DeliverySystem.DevTeam.DAL.Models.Order", "Order")
                        .WithMany("OrderProducts")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DeliverySystem.DevTeam.DAL.Models.Product", null)
                        .WithMany("OrderProducts")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("DeliverySystem.DevTeam.DAL.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("DeliverySystem.DevTeam.DAL.Models.ApplicationUser", null)
                        .WithMany()
